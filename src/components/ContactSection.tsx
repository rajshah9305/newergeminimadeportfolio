    ...
    <section id="contact" className="w-full bg-white border-t-4 border-black scroll-mt-[80px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-40">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          ...
          >
            <span className="font-mono text-[11px] font-bold tracking-[0.3em] uppercase text-primary mb-6 block">
              {`// 04 — CONTACT`}
            </span>
            ...
            <p className="font-mono text-[14px] text-black/60 uppercase tracking-[0.2em] leading-[1.8] max-w-sm">
          ...
          >
            ...
            <a
              ...
              className="group flex items-center justify-between px-8 py-8 bg-black text-white border-4 border-black hover:bg-primary hover:border-primary shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px] transition-all duration-300 focus:outline-none"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <button
                onClick={copyEmail}
                className="flex items-center justify-between px-6 py-5 bg-white text-black border-4 border-black hover:bg-black hover:text-white transition-all duration-300 focus:outline-none group"
              >
            ...
            <div className="flex items-center gap-4 pt-4">
              ...
              <a href={PERSONAL_INFO.linkedin} target="_blank" rel="noreferrer"
                 className="text-black hover:text-primary transition-colors font-mono text-[12px] font-black uppercase tracking-[0.2em] flex items-center gap-2">
